...
public class JWT {
    ...
    private static final EntityManagerFactory factory = Persistence.createEntityManagerFactory("seguridadInformaticaBD");
    ...
    private static final String SUBJECT = "SeguridadInformatica";
